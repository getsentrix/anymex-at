...
3. Tap **+** and paste: `https://getsentrix.github.io/anymex-at/apps.json`
*(Or tap "Add to LiveContainer" directly from the [web page](https://getsentrix.github.io/anymex-at/))*
